$(function(){
	...
	myBlog.GridManager.postsGrid = function (gridName, pagerName) {
        ...
        var addOptions = {
			...
			onClose: onClose,
			afterSubmit: myBlog.GridManager.afterSubmitHandler,
	...
	myBlog.GridManager.categoriesGrid = function (gridName, pagerName) {
	...
	myBlog.GridManager.tagsGrid = function (gridName, pagerName) {
		var colNames = ['Id', 'Name', 'Url Slug', 'Description'];
	...
	myBlog.GridManager.afterSubmitHandler = function(response, postdata) {
